    ...
    return (
        ...
        <section className="text-gray-600 body-font ">
            ...
            <h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center">Achievments</h1>
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}whileHover={{scale:1.2, border: "3px solid purple",borderRadius:'20px'}} className="flex items-center lg:w-4/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                ...
                <motion.div whileHover={{scale:1.2, border: "3px solid purple",borderRadius:'20px'}} className="flex items-center lg:w-4/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                    <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
